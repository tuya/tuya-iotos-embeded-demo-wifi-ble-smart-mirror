 ...
 * @LastEditTime: 2021-06-07 17:56:27
 */
...
/* 配网按键相关宏,长按进入配网模式 */
#define WIFI_KEY_PIN                TY_GPIOA_24 //按键引脚 
...
{   
    ...
    ty_uart_init_mk(TY_UART1, TYU_RATE_115200, TYWL_8B, TYP_NONE, TYS_STOPBIT1);
#endif
    /* WiFi 按键，led 初始化 */
    wifi_config_init();
    return;
